...
rw_proxy is a reverse proxy server utilized to aggregate 5 microservices built to mimic the functionality and looks of the item description page on the Best Buy website. It was deployed on an AWS EC2 Ubuntu instance.
...
## Product Reviews
![Product Reviews](https://github.com/ATX-50-Team-Best-Buy/rw_proxy/blob/master/GIF%20add%20review%208:22.gif)
